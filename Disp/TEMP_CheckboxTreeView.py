...
IM_CHECKED = os.path.join(ASSETS_DIR, "checked.png")      # These three checkbox icons were isolated from
IM_UNCHECKED = os.path.join(ASSETS_DIR, "unchecked.png")  # Checkbox States.svg (https://commons.wikimedia.org/wiki/File:Checkbox_States.svg?uselang=en)
IM_TRISTATE = os.path.join(ASSETS_DIR, "tristate.png")    # by Marekich [CC BY-SA 3.0  (https://creativecommons.org/licenses/by-sa/3.0)]
...
class CheckboxTreeview(ttk.Treeview):
    ...
    def __init__(self, master=None, **kw):
        ...
        self.im_checked = tk.PhotoImage(file=IM_CHECKED)
        self.im_unchecked = tk.PhotoImage(file=IM_UNCHECKED)
        self.im_tristate = tk.PhotoImage(file=IM_TRISTATE)
